 ...
 * <ul>
 *   <li>{@link main.subkdm.impl.ControlElementImpl#getCodeElement <em>Code Element</em>}</li>
 *   <li>{@link main.subkdm.impl.ControlElementImpl#getType <em>Type</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ControlElementImpl extends ComputationalObjectImpl implements ControlElement {
	...
	protected EClass eStaticClass() {
		return SubkdmPackage.Literals.CONTROL_ELEMENT;
	}
	...
	public EList<AbstractCodeElement> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<AbstractCodeElement>(AbstractCodeElement.class, this, SubkdmPackage.CONTROL_ELEMENT__CODE_ELEMENT);
		}
		return codeElement;
	}
		...
		if (type != null && type.eIsProxy()) {
			...
			if (type != oldType) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, SubkdmPackage.CONTROL_ELEMENT__TYPE, oldType, type));
			}
		}
		return type;
	}
	...
	public void setType(DataType newType) {
		...
		type = newType;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SubkdmPackage.CONTROL_ELEMENT__TYPE, oldType, type));
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SubkdmPackage.CONTROL_ELEMENT__CODE_ELEMENT:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			...
			case SubkdmPackage.CONTROL_ELEMENT__TYPE:
