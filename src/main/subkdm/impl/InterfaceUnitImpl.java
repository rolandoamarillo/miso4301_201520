 ...
 * <ul>
 *   <li>{@link main.subkdm.impl.InterfaceUnitImpl#getCodeElement <em>Code Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class InterfaceUnitImpl extends DataTypeImpl implements InterfaceUnit {
	...
	protected EClass eStaticClass() {
		return SubkdmPackage.Literals.INTERFACE_UNIT;
	}
	...
	public EList<CodeItem> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<CodeItem>(CodeItem.class, this, SubkdmPackage.INTERFACE_UNIT__CODE_ELEMENT);
		}
		return codeElement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SubkdmPackage.INTERFACE_UNIT__CODE_ELEMENT:
