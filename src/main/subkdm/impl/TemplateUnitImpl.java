 ...
 * <ul>
 *   <li>{@link main.subkdm.impl.TemplateUnitImpl#getCodeElement <em>Code Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class TemplateUnitImpl extends DataTypeImpl implements TemplateUnit {
	...
	protected EClass eStaticClass() {
		return SubkdmPackage.Literals.TEMPLATE_UNIT;
	}
	...
	public EList<CodeUnit> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<CodeUnit>(CodeUnit.class, this, SubkdmPackage.TEMPLATE_UNIT__CODE_ELEMENT);
		}
		return codeElement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SubkdmPackage.TEMPLATE_UNIT__CODE_ELEMENT:
