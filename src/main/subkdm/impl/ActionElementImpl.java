 ...
 * <ul>
 *   <li>{@link main.subkdm.impl.ActionElementImpl#getKind <em>Kind</em>}</li>
 *   <li>{@link main.subkdm.impl.ActionElementImpl#getCodeElement <em>Code Element</em>}</li>
 *   <li>{@link main.subkdm.impl.ActionElementImpl#getActionRelation <em>Action Relation</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ActionElementImpl extends AbstractCodeElementImpl implements ActionElement {
	...
	protected EClass eStaticClass() {
		return SubkdmPackage.Literals.ACTION_ELEMENT;
	}
	...
	public void setKind(String newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SubkdmPackage.ACTION_ELEMENT__KIND, oldKind, kind));
	}
	...
	public EList<AbstractCodeElement> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<AbstractCodeElement>(AbstractCodeElement.class, this, SubkdmPackage.ACTION_ELEMENT__CODE_ELEMENT);
		}
		return codeElement;
	}
	...
	public EList<AbstractActionRelationship> getActionRelation() {
		if (actionRelation == null) {
			actionRelation = new EObjectContainmentEList<AbstractActionRelationship>(AbstractActionRelationship.class, this, SubkdmPackage.ACTION_ELEMENT__ACTION_RELATION);
		}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SubkdmPackage.ACTION_ELEMENT__CODE_ELEMENT:
				return ((InternalEList<?>)getCodeElement()).basicRemove(otherEnd, msgs);
			case SubkdmPackage.ACTION_ELEMENT__ACTION_RELATION:
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SubkdmPackage.ACTION_ELEMENT__KIND:
				return getKind();
			case SubkdmPackage.ACTION_ELEMENT__CODE_ELEMENT:
