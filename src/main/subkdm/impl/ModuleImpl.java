 ...
 * <ul>
 *   <li>{@link main.subkdm.impl.ModuleImpl#getCodeElement <em>Code Element</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ModuleImpl extends CodeItemImpl implements Module {
	...
	protected EClass eStaticClass() {
		return SubkdmPackage.Literals.MODULE;
	}
	...
	public EList<AbstractCodeElement> getCodeElement() {
		if (codeElement == null) {
			codeElement = new EObjectContainmentEList<AbstractCodeElement>(AbstractCodeElement.class, this, SubkdmPackage.MODULE__CODE_ELEMENT);
		}
		return codeElement;
	}
	...
	public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs) {
		switch (featureID) {
			case SubkdmPackage.MODULE__CODE_ELEMENT:
