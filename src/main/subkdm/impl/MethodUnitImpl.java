 ...
 * <ul>
 *   <li>{@link main.subkdm.impl.MethodUnitImpl#getKind <em>Kind</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class MethodUnitImpl extends ControlElementImpl implements MethodUnit {
	...
	protected EClass eStaticClass() {
		return SubkdmPackage.Literals.METHOD_UNIT;
	}
	...
	public void setKind(CallableKind newKind) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, SubkdmPackage.METHOD_UNIT__KIND, oldKind, kind));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case SubkdmPackage.METHOD_UNIT__KIND:
				return getKind();
		}
