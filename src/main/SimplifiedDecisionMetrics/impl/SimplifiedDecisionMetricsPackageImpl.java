...
import main.SimplifiedDecisionMetrics.DimensionalMeasurement;
import main.SimplifiedDecisionMetrics.Grade;
import main.SimplifiedDecisionMetrics.Measure;
import main.SimplifiedDecisionMetrics.Measurement;
import main.SimplifiedDecisionMetrics.MofElement;
import main.SimplifiedDecisionMetrics.Observation;
import main.SimplifiedDecisionMetrics.SimplifiedDecisionMetrics;
import main.SimplifiedDecisionMetrics.SimplifiedDecisionMetricsFactory;
import main.SimplifiedDecisionMetrics.SimplifiedDecisionMetricsPackage;

import main.subkdm.SubkdmPackage;

import main.subkdm.impl.SubkdmPackageImpl;
...
public class SimplifiedDecisionMetricsPackageImpl extends EPackageImpl implements SimplifiedDecisionMetricsPackage {
	 ...
	 * @see main.SimplifiedDecisionMetrics.SimplifiedDecisionMetricsPackage#eNS_URI
	 * @see #init()
	 * @generated
	 */
	...
	public static SimplifiedDecisionMetricsPackage init() {
		...
		SubkdmPackageImpl theSubkdmPackage = (SubkdmPackageImpl)(EPackage.Registry.INSTANCE.getEPackage(SubkdmPackage.eNS_URI) instanceof SubkdmPackageImpl ? EPackage.Registry.INSTANCE.getEPackage(SubkdmPackage.eNS_URI) : SubkdmPackage.eINSTANCE);
	...
	public void initializePackageContents() {
		...
		SubkdmPackage theSubkdmPackage = (SubkdmPackage)EPackage.Registry.INSTANCE.getEPackage(SubkdmPackage.eNS_URI);
		...
		initEReference(getMofElement_Element(), theSubkdmPackage.getModelElement(), null, "element", null, 0, 1, MofElement.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
